...
\eq{eq:zsort:replmask:2}{
	I(x, y) = (1 - \alpha_{C_T}) * C_F(x, y) + \alpha_{C_T} * V(x, y)
}

\eq{eq:zsort:replmask:3}{
	\alpha_{C_S} = \alpha_{C_B} * (1 - \alpha_{I(x, y)})
}


\eq{eq:zsort:replmask:4}{
	J(x, y) = (1 - \alpha_{C_S}) * I(x, y) + \alpha_{C_S} * C_B(x, y)
}
...
\eq{eq:zsort:alphamask:3}{
	I(x, y) = (1 - \alpha_{C_T}) * C_V(x, y) + \alpha_{C_T} * C_B(x, y)
}
