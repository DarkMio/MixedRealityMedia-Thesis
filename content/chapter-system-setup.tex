...
that have to be performed for a mixed reality composition. \todo{maybe a bit 
short?}
...
degrees of freedom (6DOF)\todo{6DOF was defined earlier iirc} tracking. The 
...
equipment transformation in sync\todo{sync?}, so I've built a mount that fits 
