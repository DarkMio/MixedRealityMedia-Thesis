...
- this was made by a checkbox to show raw output from the camera. \todo{Image 
of the material editor} Then an average green from the background box can be 
...
\end{figure} \todo{Maybe put a highlight of the image together}
...
\todo{this is very rough and only contains equations currently used - also 
could need a better explanation for energy leveling}
...
algorithms hard to remove without rough image results. \todo{Could need an 
example case with real matting soft/hardware}
