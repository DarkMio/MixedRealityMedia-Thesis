...
\newcommand{\thesisVersion}{Pre Finalization}

\newcommand{\thesisFirstReviewer}{Prof. Dr.-Ing. Kristian Hildebrand}
...
\newcommand{\circled}[1]{%
	\tikz[inner sep=.15ex,baseline=-.55ex] \node[circle,draw] {#1};
}
...
\input{content/chapter-extending-reality}
\input{content/chapter-system-setup}
\input{content/chapter-video2mr}
\input{content/chapter-evaluation}
\input{content/chapter-conclusion}
\input{content/chapter-related}
\cleardoublepage
